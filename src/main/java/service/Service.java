...
public class Service {
    ...
    public int saveStudent(String id, String nume, int grupa, String email, String profName) {
        Student student = new Student(id, nume, grupa, email, profName);
    ...
    public int updateStudent(String id, String numeNou, int grupaNoua, String emailNou, String profNameNou) {
        Student studentNou = new Student(id, numeNou, grupaNoua, emailNou, profNameNou);
