...
public class UI {
    ...
    public void uiSaveStudent() {
        ...
        System.out.println("Introduceti email studentului: ");
        String email = scanner.nextLine();

        System.out.println("Introduceti numele profului studentului: ");
        String profName = scanner.nextLine();

        if (service.saveStudent(id, nume, grupa, email, profName) != 0) {
    ...
    public void uiUpdateStudent() {
        ...
        System.out.println("Introduceti noul email studentului: ");
        String email = scanner.nextLine();

        System.out.println("Introduceti noul numele profului studentului: ");
        String profName = scanner.nextLine();


        if (service.updateStudent(id, numeNou, grupaNoua, email, profName) != 0) {
