...
public class Student implements HasID<String> {
    ...
    private String nameOfTheProfessor;

    public String getNameOfTheProfessor() {
        return nameOfTheProfessor;
    }

    public void setNameOfTheProfessor(String nameOfTheProfessor) {
        this.nameOfTheProfessor = nameOfTheProfessor;
    }
    ...
    public String toString() {
        return "Student{" +
                ...
                ", grupa=" + grupa +
                ", email='" + email + '\'' +
                ", nameOfTheProfessor='" + nameOfTheProfessor + '\'' +
                '}';
    }
